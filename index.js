...
function launchBot() {
  ...
  // Start the web pairing page too, so people without Telegram can also pair
  try {
    require('./webpair');
  } catch (e) {
    console.log(chalk.red('❌ Web pairing page failed to start: ' + e.message));
  }

  console.log(chalk.green('✅ 𝙽𝚈𝚇𝙴𝙽 𝙼𝙳 𝙸𝚂 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳 𝚂𝚄𝙲𝙲𝙴𝚂𝚂𝙵𝚄𝙻𝙻𝚈!'));
